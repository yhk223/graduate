        ...
        <div class="search">
            <div class="search-fenlei" id="search-fenlei">
                ...
                <!-- <div class="search-list">
                    <ul><li class="search-list-icon1"><a href="javascript:void(0)" rel="nofollow"><span
            ...
            <form name="top_goods_search" id="top_goods_search" action="mobile/search" method="post">
...
<div class="search_list">
    <div class="page">
        <div class="current"><a href="user/index/1">首页</a><span>></span><a href="user/index/1">闲置回收</a>
            <span>></span><a href="user/index/1">手机</a>
            <em></em>
        </div>
        <div class="side_left">
            <dl class="side_list">
                ...
                <c:forEach items="${cateList}" var="cate">
                    <dd class=""><a href="user/showCategory/${cate.id}&1" title="${cate.title}"><b
                            class="item${cate.id}">&nbsp;</b><em>${cate.name}</em><span>&nbsp;</span></a></dd>
                </c:forEach>
            </dl>
            <dl class="side_hot">
                <dt>最近热门回收</dt>
                <dd>
                    ...
                    <div class="txt2">
                        <p style="width:120px;">
                            <a href="user/index/1" title="ipad mini回收价格评估">ipad mini</a></p>462
                    </div>
                    <div class="clear"></div>
                </dd>
            </dl>
                ...
                <div class="brand_main">
                    <div class="brand_hot">
                        ...
                        <c:forEach items="${list}" var="brank">
                            ...
                            <em>|</em>  <a href="user/index3/${brank.brandid}&1">${brank.brandname}</a><em>|</em>
            ...
            <div class="search_main">
                    ...
                    <c:forEach items="${mobilelist}" var="mobilelist">
                        <dd>
                            <div class="pic_list_box">
                                <div class="pic_list_img"><a href="mobile/baseInfo/${mobilelist.mobileid}" title="回收价格评估"><img
                                        src="${mobilelist.mobileimg}" width="180"
                                        height="135" alt="闲置回收价格评估"/></a></div>
                                <p class="name">${mobilelist.userstyle}</p>
                                <p class="price">最高价：<em>${mobilelist.price}</em></p>
                                <p class="pinggu"><a href="mobile/baseInfo/${mobilelist.mobileid}"><!--去评估--></a>
                                </p>
                ...
                <div class="pageStr">
                    <div class="ihuigo_page">
                        ...
                        <span><a href="user/index3/${brankid}&${page}">${page}</a></span>
                        </c:forEach>
                        <span class="buttenxx" name="bttnext"  onClick="donext()"><a>下一页</a></span>
                        <%--<input type="button" name="bttnext" value="下一页" onClick="donext()"/>--%>
                        <span class="last_link"><a href="user/index3/${brankid}&${pages}">尾页</a></span>
                        <input type="hidden" name="brankid" value=${brankid} />
...
<script type="text/javascript">
function donext(){
    var brankid=$("input[name='brankid']").val();
    var page=$("input[name='page']").val();
    $.post(
        "mobile/checkByBrankid",{
            brankId:brankid,
            page:page
        },function(data,status){
            if(data=="success"){
                window.location.href="user/index3/${brankid}&${page+1}";
            }else {
                alert("已到最后一页");
            }
        });
