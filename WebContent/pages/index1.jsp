...
<script type="text/javascript">
    function donext(){
        ...
        $.post(
            "mobile/checkByCateid",{
                id:id,
                page:page
            },function(data,status){
                if(data=="success"){
                    window.location.href="user/showCategory/${id}&${page+1}";
                }else {
                    alert("已到最后一页");
                }
            });
