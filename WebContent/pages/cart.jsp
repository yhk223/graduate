...
<form name="myFrom" id="myFrom" method="post">
    ...
    <div class="contanier page">
        ...
        <div style="padding:0 15px;">
                ...
                <div class="sub_con_top">
                    ...
                    <div   id="new_member_addr_div">
                        ...
                        <ul class="contact_list">
                            ...
                            <li class="contact_texts"><span class="img_1"><img
                                    ...
                                    <span class="img_2">
                                    <input id="linkname" name="linkname" type="text"></span>
                                     <span class="img_1">
                                     <img   src="images/in_1.gif" style="transform: rotate(180deg)"></span><span class="img_3"><em style="color: red; font-size:12px;margin-right: 10px;">*</em></span> </li>
                            <div class="clear"></div>
                        </ul>
                        <ul class="contact_list">
                            <li class="contact_text">手机号码：</li>
                            <li class="contact_texts"><span class="img_1"><img
                                    src="images/in_1.gif"></span><span class="img_2"><input name="phone" id="phone" type="text"></span> <span class="img_1"><img
                                    src="images/in_1.gif" style="transform: rotate(180deg)"></span><span class="img_3"><em style="color: red; font-size:12px;margin-right: 10px;">*</em></span> </li>
                            <div class="clear"></div>
                        </ul>
                        ...
                        <div>
                            <ul class="contact_list">
                                ...
                                <li class="contact_texts"><span class="img_1"><img
                                        src="images/in_1.gif"></span><span class="img_2_area"><input name="fulladdress" id="fulladdress" type="text"></span> <span class="img_1"><img
                                    src="images/in_1.gif" style="transform: rotate(180deg)"></span></li>
                                <div class="clear"></div>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="contact_list" style="margin-top:20px;">
                        <div id="div_addr" style="display:none;">
                            ...
                            <ul class="area_list">
                                <li class="area_list_texts"><input name="shangmenshijian" id="shangmenshijian" type="text" style="border:0px;" onfocus="return showCalendar('stime', '%Y-%m-%d %H:%m', '24', false, 'stime');"  value=""></li>
                    ...
                    <div class="sub_con_foot">
                        ...
                        <div   id="new_member_bank_div">
                                ...
                                <ul>
                                    ...
                                    <li class="contact_select">
                                        <select name="bankname" id="bankname">
                                            ...
                                            <option value="14">长沙银行</option>
                                            <option value="15">深圳发展银行</option>
                                            <option value="16">广东发展银行</option>
                                            <option value="17">平安银行</option>
                                            <option value="18">渤海银行</option>
                                            <option value="19">天津银行</option>
                                            <option value="20">北京农村商业银行</option>
                                            <option value="21">上海浦东发展银行</option>
                                            <option value="22">上海银行</option>
                                            <option value="23">江苏银行</option>
                                            <option value="24">南京银行</option>
                                            <option value="25">浙商银行</option>
                                            <option value="26">温州银行</option>
                                            <option value="27">杭州银行</option>
                                            <option value="28">宁波银行</option>
                                            <option value="29">宁波国际银行</option>
                                            <option value="30">绍兴银行</option>
                                            <option value="31">徽商银行</option>
                                            <option value="32">湛江市商业银行</option>
                                            <option value="33">广州银行</option>
                                            <option value="34">珠海市商业银行</option>
                                            <option value="35">东莞银行</option>
                                            <option value="36">深圳农村商业银行</option>
                                            <option value="37">广州农村商业银行</option>
                                            <option value="38">东莞农村商业银行</option>
                                            <option value="39">佛山顺德农村商业银行</option>
                                            <option value="40">华商银行</option>
                                        </select>
                                        <span class="img_3"><em style="color: red; font-size:12px;margin-right: 10px;">*</em></span> </li>
                                    <div class="clear"></div>
                                </ul>
                            ...
                            <ul class="contact_list">
                                ...
                                <li class="contact_texts"><span class="img_1"><img
                                        src="ihuigo/images/in_1.gif"></span><span class="img_2"><input name="bankidname" id="bankidname" type="text"></span> <span class="img_1"><IMG src="ihuigo/images/in_3.gif"></span><span class="img_3"><em style="color: red; font-size:12px;margin-right: 10px;">*</em></span> <span class="contact_textsval">开户时的真实姓名</span></li>
                                <div class="clear"></div>
                            </ul>
                            <ul class="contact_list" style="position:relative">
                                <li class="contact_text">银行帐号：</li>
                                <li class="contact_texts"><span class="img_1"><img
                                        src="ihuigo/images/in_1.gif"></span><span class="img_2"><input name="bankid" id="bankid" type="text" onkeyup="show_card_sn_format()" onfocus="show_card_sn_format()" onblur="card_sn_blur()"></span> <span class="img_1"><!-- <IMG src="ihuigo/images/in_3.gif"> --></span><span class="img_3"><em style="color: red; font-size:12px;margin-right: 10px;">*</em></span> <span class="contact_textsval">我们对用户帐号信息严格保密，请放心填写！</span></li>
                                <div class="clear"></div>
            ...
            <div  id="s1" class="block">
                ...
                <div class="sub_con_foot">
                    <div class="contact_ways m_unclock">
                        ...
                        <div class="alertTips">
                            <p>iPhone设置取消开机密码<span>设置-Touch ID和密码-点击关闭密码</span></p>
                            <p>iPhone关闭iCloud<span>设置-iCloud-注销-从我的iPhone删除-输入密码-删除</span></p>
            ...
            <script>
                function doording() {
                    var bank1=$("#bankname option:selected");
                    var bankName = bank1.text();
                    $("#myBank").val(bankName);
                    var province = $("#text_province").text();
                    $("#myProvince").val(province);
                    var city = $("#text_city").text();
                    $("#myCity").val(city);
                    var district = $("#text_district").text();
                    $("#myDistrict").val(district);
                    var number = $("input[name='number']").val();

                    var form = $("#myFrom");

                    form.attr('action',"user/saveording");
                    form.submit();
                ...
                <div class="sub_con_foot">
                    ...
                    <div  id="new_member_alipay_div">
                        ...
                        <ul class="contact_list">
                            ...
                            <li class="contact_texts"><span class="img_1"><img
                                        src="images/in_1.gif"></span><span class="img_2"><input name="alipayname" id="alipayname" type="text" value=""></span> <span class="img_1"><img
                                    src="images/in_1.gif" style="transform: rotate(180deg)"></span><span class="img_3"><em style="color: red; font-size:12px;margin-right: 10px;">*</em></span> </li>
                            <div class="clear"></div>
                        </ul>
                        ...
                        <ul class="contact_list">
                            ...
                            <li class="contact_texts"><span class="img_1"> <img
                                    src="images/in_1.gif"></span><span class="img_2"><input name="alpayaccount" id="alpayaccount" type="text" value="" ></span> <span class="img_1"><img
                                    src="images/in_1.gif" style="transform: rotate(180deg)">
                                    </span><span class="img_3"><em style="color: red; font-size:12px;margin-right: 10px;">*亲，必须是实名认证的支付宝账号哦！</em></span> </li>
                            <div class="clear"></div>
                        </ul>
                    </div>
            ...
            <div id="s3" class="none" >
                <!-- 回购点start-->
                <div class="sub_con_foot">
                    <div class="contact_ways">面交方式(目前仅支持<b style="color:#f60">武汉</b>地区当面交易，其它地区请选择<b style="color:#f60">官方担保交易</b>)</div>
                    ...
                    <div class="contanct_c" id="div_mianjiao_method_2">
                        <label>
                            ...
                            <span >目前支持武汉光谷周边地区（建议选择地铁口面交）</span>
                        </label>
                    </div>

                    <link href="ihuigo/js/new_js/My97DatePicker/skin/WdatePicker.css" rel="stylesheet" type="text/css"/>
                    <script src="ihuigo/js/new_js/My97DatePicker/WdatePicker.js" type="text/javascript"></script>
      ...
      您可选择<a href="http://www.ihuigo.com/html/baoxian.html" style="background:none; padding:0px; color:#03F; font-weight:bold;" target="_blank">参与中国人民财产保险投保计划</a></span>
            ...
            <input type="button" name="sub_button" id="sub_button" value="提交回购单" class="input_btn2" onclick="doording()" />
        </div>
        ...
        <dl id="baoxian_content" style="display:none;">
            ...
            <dd style="height:20px; line-height:20px;"><img src="ihuigo/images/new_images/picc.jpg" style="vertical-align:middle; margin-right:6px;" />旧手机隐私信息泄露或运输丢失，人保理赔五千元</dd>
    ...
    <!--订单-->
    <div class="dingdan">
        <div class="contact_way">订单详情：<input type=hidden name="mobileprice" id="mobileprice" value="${sumprice}" />元</div>
        <table width="100%" border="0" cellpadding="0" cellspacing="1"  class="table1">
            ...
            <tr>
                <td height="95" align="center">
                    <div class="contact_way_img"><img src="${cartlist.mobileimg}"></div>
                ...
                <td><a href="user/deletcart/${cartlist.cartid}">移除</a></td>
            </c:forEach>
        ...
        <div class="foot_bor"> <em></em>产品总计回收价格<em style="font-size:18px;">${sumprice}</em> <!--<span>赠送环保券 <i>30</i>元--></span></div>
    </div>
    <!--订单-->
    </div>
    <!--提交订单-->
