...
<div class="recovery">
    <div class="page2">
        <div class="heat_l" style="width:276px;">
            ...
            <input type="hidden" name="mobilestyle" value="${mobile.userstyle}">
            <input type="hidden" name="mobileprice" value="${mobile.price}">
            <input type="hidden" name="mobileimg" value="${mobile.mobileimg}">
            <div class="heat_img"><img src="${mobile.mobileimg}" width="264" height="197" /></div>
        </div>
        <div class="heat_new">
            <input type="hidden" name="typeid" id="typeid" value="1" />
            <dl>
                <dt><span>请选择一种回购方式</span><a href="mobile/baseInfo/${mobile.mobileid}">重新评估</a></dt>
                <dd class="clearfix heat_on" name="1">
                    <div class="heat_yellow"> <img src=" images/new_jian.png" class="new_jian" />
                        ...
                        <div class="yellow_r"> <span>全网最高</span>
                            <div id="pg_price" class="digits">${mobile.price}</div>
                            <input type="hidden" name="description" value="${description}"/>
                            <span>元&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;官方直收</span>
                            <div class="clear"></div>
                        </div>
                    </div>
                    <input type="button" value="立即下单" class="heat_input" onclick="addcart()" />
...
<div class="content page2">
    ...
    <div class="side">
        ...
        <div class="bar1">
            ...
            <a id="nav_s2"  onclick="_nav('nav_s',2,3);show_goods_review('common.jsp');">交易评价(999+)</a><a id="nav_s3" onclick="_nav('nav_s',3,3);show_goods_zhijian('help.jsp');">了解我们如何质检</a> </div>
        ...
        <div class="list" id="nav_s_list2" style="display:none">
            <iframe id="goods_review" name="goods_review" src=""  width="724" height="724" border="0" frameborder="0" 
          
            ></iframe>
        </div>
        <div class="list" id="nav_s_list3" style="display:none">
            <iframe id="goods_zhijian" name="goods_zhijian" src=""  width="724" height="724"  border="0" frameborder="0"></iframe>
        </div>
    </div>
    <!--回购须知-->
    <div class="notes">
...
<script type="text/javascript">
    function addcart(){
        ...
        var img=$("input[name='mobileimg']").val();
        var mobilePrice=$("input[name='mobileprice']").val();
        var mobile=$("input[name='mobilestyle']").val();
        ...
        $.post(
            "user/addcart",{
                ...
                if(data=="OK1"){
                    alert("加入购物车成功");
                    window.location.href="user/ording/"+userid;
                }else{
                    alert("传值失败");
                }
            });
